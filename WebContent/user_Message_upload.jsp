    ...
    <div id="wrapper">
            ...
            <form id="add-comment" class="add-comment" action="<%=request.getContextPath()%>/message_Edit?operator=update_message" method="post">
                <fieldset>
                    ...
                    <div>
                        ...
                        <textarea cols="20" rows="3" id="mess" name="mess">${sessionScope.user.message}</textarea>
                    </div>
        ...
        <div class="container">
            <div class="sixteen columns">
                <!-- Tabs Navigation -->
                <ul class="tabs-nav">
                   <li class="active"><a href="<%=request.getContextPath()%>/message_Edit?operator=show_mess_upload">菜谱作品</a></li>
                    <li ><a href="<%=request.getContextPath()%>/message_Edit?operator=show_mess_save">菜谱收藏</a></li>
