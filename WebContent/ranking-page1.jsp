        ...
        <div class="advanced-search-container">
            <div class="container">
                <div class="sixteen columns">
                    <!-- Tabs Navigation -->
                     <ul class="tabs-nav">
                        <li id="current" ><a href="<%=request.getContextPath()%>/ranking_Page?operator=hot_week"><font color=858585>北京家常菜</font></a></li>
                        <li><a href="<%=request.getContextPath()%>/ranking_Page?operator=steam_of_people">广州家常菜</a></li>
                        <li><a href="<%=request.getContextPath()%>/ranking_Page?operator=show">节目菜单（向往的生活）</a></li>
