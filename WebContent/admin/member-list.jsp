	...
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		<thead>
			<tr class="text-c">
                ...
                <th width="40">性别</th>
                <th width="40">年龄</th>
                <th width="200">喜欢的菜谱</th>
				<th width="200">描述</th>
			</tr>
		</thead>
		
		<tbody>
		<c:forEach items="${sessionScope.users_admin }" var="u">
			<tr class="text-c">
				<td><input type="checkbox" value="1" name=""></td>
				<td><a  href="<%=request.getContextPath() %>/adminServlet?operator=Mess_Edit&username=${u.username}" style="text-decoration:underline">${u.username }</a></td>
